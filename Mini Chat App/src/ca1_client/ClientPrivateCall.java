 ...
 * @author abdul
 */
public class ClientPrivateCall extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!host.equals("")) {
            try {
                ...
                playbackInfo = new DataLine.Info(SourceDataLine.class, captureFormat);
                ...
                Thread captureThread = new Thread(() -> {
                    ...
                    while (true) {
                        if(!isMuted){
                            ...
                            java.util.logging.Logger.getLogger(ClientPrivateCall.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                        }
                        }
                    }
                });
            ...
            JOptionPane.showMessageDialog(rootPane, "Enter server IP Address",
                    "Error", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(rootPane, "You have to make a call to the server first",
                    "Error", JOptionPane.ERROR_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClientPrivateCall().setVisible(true);
            }
        });
    }
